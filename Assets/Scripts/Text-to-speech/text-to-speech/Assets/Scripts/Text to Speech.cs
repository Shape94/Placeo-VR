...
{  public PlayfabManager playfabManager;
    ...
    private Animator mAnimator; //AGGIUNTOOOOOOOOOOOOOOO
    ...
    {        
        ...
        if(mAnimator != null)   //AGGIUNTOOOOOOOO
            {
                mAnimator.SetTrigger("Talking");
                Debug.Log("TALKING");
            }
        ...
        lock (threadLocker)
        {
         ...
         /*playfabManager.SendLeaderboard(20);
         playfabManager.GetLeaderboard();
         playfabManager.SaveAppearance();
         playfabManager.GetAppearance();
         playfabManager.SaveCharacters();
         playfabManager.RegisterButton();
         playfabManager.LoginButton();
         playfabManager.ResetPasswordButton();*/
         playfabManager.ExecuteButton();
    }

    void Start()
    { 
        mAnimator = GetComponent<Animator>(); //AGGIUNTOOOOOOOOOOO
         if (inputField == null)
        {
        ...
        else
        {
            ...
            inputField.text = "Inserisci il testo che vuoi!";
            ...
            speechConfig.SpeechSynthesisVoiceName = "it-IT-GiuseppeMultilingualNeural"; 
    ...
    void Update()
    {
        ...
        if (!audioSource.isPlaying) //AGGIUNTOOOOOOO
        {
          // if(mAnimator != null)  //AGGIUNTOOOOOOOOOOO
                        // {
